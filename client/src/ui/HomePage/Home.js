...
export default withStyles(useStyles)(
    class Home extends React.Component {
        ...
        getCompanies = async () => {
            try {
                const url = new URL(`${server}/company`); // TODO: handle dev vs prod enviroments
        ...
        fetchCurrentPage = async (page) => {
            try {
                const params = { page: page, pageSize: this.state.pageSize, isPublished: true, isStream: false }; // TODO: Filter by category
                ...
                <div className="Home">
                    ...
                    <div className="homeContent">
                        ...
                        <Grid container className="homePosts">
                            <Grid item xs={12}>
                                {this.state.isLoaded ? <Content posts={this.state.posts} /> : null}
                                {this.state.isLoaded && this.state.numPages > 1 ? <Pagination page={this.state.page + 1} onChange={this.onPageChange}
